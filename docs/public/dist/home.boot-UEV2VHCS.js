import{b as n}from"./runtime-VMJA3Z4N.js";import{a as r}from"./runtime-QFURDKA2.js";import{a as i,b as o}from"./runtime-B73WLANC.js";var l={current:null};var c={name:"@invisibleloop/pulse",version:"0.1.28",type:"module",description:"AI-first frontend framework. The spec is the source of truth.",license:"MIT",bin:{pulse:"./src/cli/index.js"},types:"./types/index.d.ts",exports:{".":{types:"./types/index.d.ts",default:"./src/server/index.js"},"./server":{types:"./types/server.d.ts",default:"./src/server/index.js"},"./runtime":{types:"./types/runtime.d.ts",default:"./src/runtime/index.js"},"./ssr":{types:"./types/ssr.d.ts",default:"./src/runtime/ssr.js"},"./navigate":{types:"./types/navigate.d.ts",default:"./src/runtime/navigate.js"},"./schema":{types:"./types/schema.d.ts",default:"./src/spec/schema.js"},"./image":{types:"./types/image.d.ts",default:"./src/runtime/image.js"},"./html":{types:"./types/html.d.ts",default:"./src/html.js"},"./ui":{types:"./types/ui.d.ts",default:"./src/ui/index.js"},"./testing":{types:"./types/testing.d.ts",default:"./src/testing/index.js"}},scripts:{dev:"node --watch src/cli/dev.js",build:"node scripts/build.js",test:"node src/spec/schema.test.js && node src/runtime/runtime.test.js && node src/runtime/ssr.test.js && node src/runtime/image.test.js && node src/server/server.test.js && node src/cli/cli.test.js && node src/ui/ui.test.js && node src/testing/testing.test.js && node src/store/store.test.js",typecheck:"tsc --noEmit",docs:"node --watch src/cli/dev.js --root docs --port 4000","docs:start":"node docs/server.js"},engines:{node:">=22"},dependencies:{"@modelcontextprotocol/sdk":"^1.27.1",esbuild:"^0.27.4"},repository:{type:"git",url:"https://github.com/invisibleloop/pulse-framework"},publishConfig:{access:"public"},devDependencies:{"@types/node":"^25.5.0",typescript:"^5.9.3"}};var{version:p}=c,h=r(`export default {
  route: '/dashboard',
  meta: {
  ...
  \`,
    ...
    <div class="home">
      ...
      <section class="hero">
        ...
        <div class="hero-badge">v${p} \u2014 EARLY ACCESS</div>
      ...
      <section class="home-code">
        <div class="home-code-inner">
          ...
          <div class="home-code-block">
            ${n({content:h,filename:"src/pages/dashboard.js",lang:"JavaScript"})}
          </div>
        </div>
      </section>
      ...
      ${s.metrics?`<section class="metrics-report" aria-labelledby="metrics-title">
        <div class="metrics-header">
          <div class="section-label">By the numbers</div>
          <h2 id="metrics-title" class="metrics-title">Performance you can measure.</h2>
          <p class="metrics-generated">Report generated ${s.metrics.generatedAt} \xB7 measured from a real Pulse build</p>
        </div>
        <div class="metrics-groups">
          <div class="metrics-group">
            <div class="metrics-group-label">Lighthouse</div>
            <div class="metrics-items">
              ${s.metrics.lighthouse.map(e=>`
      ...
      <footer class="home-footer">
        <p>MIT License \xB7 <a href="https://github.com/invisibleloop/pulse-framework" target="_blank" rel="noopener">GitHub</a> \xB7 <a href="/getting-started">Get started in 2 minutes</a></p>
      </footer>
    </div>
  `};var t=document.getElementById("pulse-root");t&&!t.dataset.pulseMounted&&(t.dataset.pulseMounted="1",i(a,t,window.__PULSE_SERVER__||{},{ssr:!0}),o(t,i));var x=a;export{x as default};
