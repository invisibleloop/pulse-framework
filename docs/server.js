...
await createServer(
  [
    ...
    new URL('./src/pages/error-pages.js',       import.meta.url),
    ...
    new URL('./src/pages/forms.js',             import.meta.url),
    ...
    new URL('./src/pages/components/gallery.js',     import.meta.url),
    new URL('./src/pages/components/input.js',       import.meta.url),
    new URL('./src/pages/components/list.js',        import.meta.url),
    new URL('./src/pages/components/marquee.js',     import.meta.url),
    new URL('./src/pages/components/modal.js',       import.meta.url),
    new URL('./src/pages/components/photo-card.js',  import.meta.url),
    ...
    new URL('./src/pages/components/decorate.js',    import.meta.url),
