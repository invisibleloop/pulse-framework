...
export const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Gallery',     href: '/components/gallery'     },
      { label: 'Input',       href: '/components/input'       },
      { label: 'List',        href: '/components/list'        },
      { label: 'Marquee',     href: '/components/marquee'     },
      { label: 'Modal',       href: '/components/modal'       },
      { label: 'Photo Card',  href: '/components/photo-card'  },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Decorate',    href: '/components/decorate'    },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Local Business',       href: '/templates/local-business'    },
