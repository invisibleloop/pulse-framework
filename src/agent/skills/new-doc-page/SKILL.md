---
name: new-doc-page
description: "Create a new documentation page for the Pulse docs site. $ARGUMENTS - Read `docs/src/lib/nav.js` to understand the full nav structure and find where the new page fits"
---
